...
import me.realignist.springboot.router.exceptions.NoHandlerFoundException;
...
public class Router {
    ...
    static void parse(Resource fileResource) throws IOException {
        String fileAbsolutePath = ((ServletContextResource) fileResource).getPath();
    ...
    public static String getFullUrl(String action, Map<String, Object> args) {
        return HTTPRequestAdapter.Companion.getCurrent().getBase() + reverse(action, args);
    }
    ...
    public static ActionDefinition reverse(String action, Map<String, Object> args) {
	    ...
	    HTTPRequestAdapter currentRequest = HTTPRequestAdapter.Companion.getCurrent();
